declare global {
  namespace HQSys {
    ...
    enum E_STOCK_HQ_DATA {
      ...
      E_SHD_3DAY_ZJ = "0x040",
      E_SHD_5DAY_ZJ = "0x080",
      E_SHD_10DAY_ZJ = "0x100",
      E_SHD_DDE = "0x200",
      E_SHD_CW = "0x400",
      E_SHD_3MIN_ZJ = "0x800",
      E_SHD_5MIN_ZJ = "0x1000",
      E_SHD_10MIN_ZJ = "0x2000",
      E_SHD_30MIN_ZJ = "0x4000",
      E_SHD_60MIN_ZJ = "0x8000",
    }
    ...
    enum E_ORDER_ITEM_TYPE {
      E_ORDER_ITEM_NO = "0x0",
      E_ORDER_ITEM_TRADE = "0x1",
      E_ORDER_ITEM_CANCEL = "0x2",
      E_ORDER_ITEM_BIG = "0x4",
      E_ORDER_ITEM_ADD = "0x8",
      E_ORDER_ITEM_PARTTRADE = "0x10",
    }
    ...
    enum H_ZH_RANK_TYPE {
      E_ZH_RANK_UP = "0x01",
      E_ZH_RANK_DROP = "0x02",
      E_ZH_RANK_SPEED_TOP = "0x04",
      E_ZH_RANK_SPEED_LAST = "0x08",
      E_ZH_RANK_WEIBI_TOP = "0x10",
      E_ZH_RANK_WEIBI_LAST = "0x20",
      E_ZH_RANK_LIANGBI = "0x40",
      E_ZH_RANK_AMOUNT = "0x80",
      E_ZH_RANK_ZHENFU = "0x100",
      E_ZH_RANK_ALL = "0x0fff",
    }

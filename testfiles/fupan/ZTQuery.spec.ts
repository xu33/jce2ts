declare global {
  namespace FuPan {
    ...
    interface ZTQuery {
      getAllTagType: (stReq: FZTAllTagTypeReq) => Promise<FZTAllTagTypeRsp>;
      getTagTypeData: (stReq: FZTTagReq) => Promise<FZTTagRsp>;
      batchUnitedStockPool: (stReq: FBatchUnitedStockPoolReq) => Promise<FBatchUnitedStockPoolRsq>;
      getZTPanKouInfo: (stReq: FZDPanKouInfoReq) => Promise<FZDPanKouInfoRsq>;
      getNumOfCallAuctionStk: (stReq: FNumOfCaUnuActTypeStkReq) => Promise<FNumOfCallAuctionStkRsp>;
      getAllCallAuctionData: (stReq: FMultiCaUnuActTypeDataReq) => Promise<FCaUnuActTypeDataRsq>;
      getCaUnuActLevelStk: (stReq: FCaUnuActLevelStkReq) => Promise<FCaUnuActLevelStkRsp>;
      getCaUnuActTypeData: (stReq: FCaUnuActTypeDataReq) => Promise<FCaUnuActTypeDataRsq>;
      batchStkCaUnuAct: (stReq: FBatchStkCaUnuActReq) => Promise<FBatchStkCaUnuActRsp>;
      batchBlkStormEyeIdx: (stReq: FBlkStormEyeIdxReq) => Promise<FBlkStormEyeIdxRsp>;
      getBlockExternData: (stReq: FBlkExtDataReq) => Promise<FBlkExtDataRsp>;
      batchStockData: (stReq: FBatchStkDataReq) => Promise<FBatchStkDataRsp>;
      getBlockStockData: (stReq: FBlkStkDataReq) => Promise<FBlkStkDataRsp>;
      getBlockBasicData: (stReq: FBlkBasicDataReq) => Promise<FBlkBasicDataRsp>;
      getUltraShortLastZTStock: (stReq: FUltraShtLastZtStkReq) => Promise<FUltraShtLastZtStkRsp>;
      getCatchBullStock: (stReq: FCatchBullStkReq) => Promise<FCatchBullStkRsp>;
      getUltraShortTermStock: (stReq: FUltraShortTermStkReq) => Promise<FUltraShortTermStkRsp>;
      getHotPointBlkStock: (stReq: FHotPointBlkStkReq) => Promise<FHotPointBlkStkRsp>;
      getBlkUnusualActionTag: (stReq: FBlkUnuActFlagReq) => Promise<FBlkUnuActFlagRsp>;
      getBlkUnusualAction: (stReq: FBlkUnuActReq) => Promise<FBlkUnuActRsp>;
      getSubNewStock: (stReq: FSubNewStockReq) => Promise<FSubNewStockRsp>;
      getZTModelStock: (stReq: FZTModelStockReq) => Promise<FZTModelStockRsp>;
      getZTTrendStock: (stReq: FZTTrendStockReq) => Promise<FZTTrendStockRsp>;
      batchSubDragonHeadStock: (stReq: FBatchSubDragonHeadStockReq) => Promise<FSubDragonHeadStockRsp>;
      getBlkChanges: (stReq: FBlkChangesReq) => Promise<FBlkChangesRsp>;
      getLeadBlkByDate: (stReq: FLeadBlkReq) => Promise<FLeadBlkRsp>;
      ...
      blkHisTurn: (stReq: FBlkHisTurnReq) => Promise<FBlkHisTurnRsp>;
      blkStockHis: (stReq: FBlkStockHisReq) => Promise<FBlkStockHisRsp>;
      blkTimeHis: (stReq: FBlkTimeHisReq) => Promise<FBlkTimeHisRsp>;
      blkLastHis: (stReq: FBlkLastHisReq) => Promise<FBlkLastHisRsp>;
      blkCurUnZT: (stReq: FBlkCurUnZTReq) => Promise<FBlkCurUnZTRsp>;
      blkCurZT: (stReq: FBlkCurZTReq) => Promise<FBlkCurZTRsp>;
      blkCurrent: (stReq: FBlkCurrentReq) => Promise<FBlkCurrentRsp>;
      marketTrendVec: (stReq: FMarketTrendReq) => Promise<FMarketTrendVecRsp>;
      marketTrend: (stReq: FMarketTrendReq) => Promise<FMarketTrendRsp>;
      boardDetail: (stReq: FBoardDetailReq) => Promise<FBoardDetailRsp>;
      batchStockPool: (stReq: FBatchStockPoolReq) => Promise<FBatchStockPoolRsp>;
      stockPool: (stReq: FStockPoolReq) => Promise<FStockPoolRsp>;
      getStockPoolFBoardPeriod: (stReq: FStockPoolFBoardPeriodReq) => Promise<FStockPoolFBoardPeriodRsp>;
      getHisFactorData: (stReq: FHisFactorReq) => Promise<FHisFactorRsp>;
    }
  }
}
export {};
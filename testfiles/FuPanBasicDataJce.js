...
// Generated from `./FuPanBasicData.jce'
// **********************************************************************
...
FuPan.E_STOCK_POOL_TYPE = {
    ...
    E_STOCK_ONE_POOL : 1,
    E_STOCK_T_POOL : 2,
    E_STOCK_CHANGE_POOL : 3,
    E_STOCK_OPEN_POOL : 4,
    E_STOCK_STRONG_POOL : 5,
    E_STOCK_COMP_POOL : 6,
    E_STOCK_LASTZT_POOL : 7,
    E_STOCK_DT_POOL : 8,
    E_STOCK_DT_OPEN_POOL : 9,
    E_STOCK_FANBAO_ZT_POOL : 10,
    E_STOCK_HIT_BOARD_POOL : 11,
    E_STOCK_BARGAIN_HUNTING_POOL : 12,
    E_STOCK_POOL_TYPE_END : 13
};

FuPan.E_STOCK_POOL_TYPE.etos = function(enm) {
    switch(enm){
        case 0 : return 'E_STOCK_ZT_POOL';
        case 1 : return 'E_STOCK_ONE_POOL';
        case 2 : return 'E_STOCK_T_POOL';
        case 3 : return 'E_STOCK_CHANGE_POOL';
        case 4 : return 'E_STOCK_OPEN_POOL';
        case 5 : return 'E_STOCK_STRONG_POOL';
        case 6 : return 'E_STOCK_COMP_POOL';
        case 7 : return 'E_STOCK_LASTZT_POOL';
        case 8 : return 'E_STOCK_DT_POOL';
        case 9 : return 'E_STOCK_DT_OPEN_POOL';
        case 10 : return 'E_STOCK_FANBAO_ZT_POOL';
        case 11 : return 'E_STOCK_HIT_BOARD_POOL';
        case 12 : return 'E_STOCK_BARGAIN_HUNTING_POOL';
        case 13 : return 'E_STOCK_POOL_TYPE_END';
    }
    return undefined;
};
...
FuPan.E_STOCK_POOL_TYPE.stoe = function(enm) {
    switch(enm){
        case 'E_STOCK_ZT_POOL' : return 0;
        case 'E_STOCK_ONE_POOL' : return 1;
        case 'E_STOCK_T_POOL' : return 2;
        case 'E_STOCK_CHANGE_POOL' : return 3;
        case 'E_STOCK_OPEN_POOL' : return 4;
        case 'E_STOCK_STRONG_POOL' : return 5;
        case 'E_STOCK_COMP_POOL' : return 6;
        case 'E_STOCK_LASTZT_POOL' : return 7;
        case 'E_STOCK_DT_POOL' : return 8;
        case 'E_STOCK_DT_OPEN_POOL' : return 9;
        case 'E_STOCK_FANBAO_ZT_POOL' : return 10;
        case 'E_STOCK_HIT_BOARD_POOL' : return 11;
        case 'E_STOCK_BARGAIN_HUNTING_POOL' : return 12;
        case 'E_STOCK_POOL_TYPE_END' : return 13;
    }
    return undefined;
};
...
FuPan.StkInfo = function() {
    this.set = 0;
    this.code = "";
    this._classname = "FuPan.StkInfo";
};
FuPan.StkInfo.prototype = new TafStream.JceStruct();
FuPan.StkInfo._classname = "FuPan.StkInfo";

FuPan.StkInfo._write = function (os, tag, value) { os.writeStruct(tag, value); }
FuPan.StkInfo._read  = function (is, tag, def) { return is.readStruct(tag, true, def); }
FuPan.StkInfo._readFrom = function (is) {
    if(is.readResumePrecision == undefined){
        is.readResumePrecision = function(){
            return -1;
        }
    ...
    is.saveResetPrecision && is.saveResetPrecision();
    var tmp = new FuPan.StkInfo();
    tmp.set = is.readInt16(1, false, 0);
    tmp.code = is.readString(2, false, "");
    tmp._jce_double_precision_ = is.readResumePrecision();
    return tmp;
};
FuPan.StkInfo.prototype._writeTo = function (os) {
    os.savePrecision && os.savePrecision(this._jce_double_precision_);
    if (this.set != undefined && this.set != 0) {
        os.writeInt16(1, this.set);
    }
...
FuPan.StkInfo.prototype._equal = function (anItem) {
    assert(false, 'this structure not define key operation');
}
FuPan.StkInfo.prototype._genKey = function () {
    if (!this._proto_struct_name_) {
        this._proto_struct_name_ = 'STRUCT' + Math.random();
    }
    return this._proto_struct_name_;
}
FuPan.StkInfo.prototype.toObject = function() { 
    var tmp = {};
...
FuPan.StkInfo.prototype.readFromObject = function(json) { 
    !json.hasOwnProperty("set") || (this.set = json.set);
    !json.hasOwnProperty("code") || (this.code = json.code);
}
FuPan.StkInfo.prototype.toBinBuffer = function () {
    var os = new TafStream.JceOutputStream();
    this._writeTo(os);
    return os.getBinBuffer();
}
FuPan.StkInfo.new = function () {
    return new FuPan.StkInfo();
}
FuPan.StkInfo.create = function (is) {
    return FuPan.StkInfo._readFrom(is);
}

...
var _TAF_MODULE_E_ = require('./CommonJce.js');
...
var _TAF_MODULE_I_ = require('./PushHqDataJce.js');
...
FuPan.FStockPoolReq = function() {
    this.stHeader = new _TAF_MODULE_E_.HQSys.HeaderInfo;
...
FuPan.FStockPoolReq._readFrom = function (is) {
    ...
    tmp.stHeader = is.readStruct(0, false, _TAF_MODULE_E_.HQSys.HeaderInfo);
...
FuPan.FLeadBlkRsp = function() {
    this.vecData = new TafStream.List(_TAF_MODULE_I_.IC.SLeadBlkInfo);
...
FuPan.FLeadBlkRsp._readFrom = function (is) {
    ...
    tmp.vecData = is.readList(0, false, TafStream.List(_TAF_MODULE_I_.IC.SLeadBlkInfo));
    tmp._jce_double_precision_ = is.readResumePrecision();
    return tmp;
};
...
FuPan.FBlkChangesReq = function() {
    this.stHeader = new _TAF_MODULE_E_.HQSys.HeaderInfo;
    this.iDate = 0;
    this.eType = _TAF_MODULE_I_.IC.BLOCKCHANGE_TYPE.E_TYPE_BKALL;
...
FuPan.FBlkChangesReq._readFrom = function (is) {
    ...
    tmp.stHeader = is.readStruct(0, false, _TAF_MODULE_E_.HQSys.HeaderInfo);
    tmp.iDate = is.readInt32(1, false, 0);
    tmp.eType = is.readInt32(2, false, _TAF_MODULE_I_.IC.BLOCKCHANGE_TYPE.E_TYPE_BKALL);
...
FuPan.FBlkChangesRsp = function() {
    this.vecData = new TafStream.List(_TAF_MODULE_I_.IC.SBlockChange);
...
FuPan.FBlkChangesRsp._readFrom = function (is) {
    ...
    tmp.vecData = is.readList(0, false, TafStream.List(_TAF_MODULE_I_.IC.SBlockChange));
    tmp._jce_double_precision_ = is.readResumePrecision();
    return tmp;
};
